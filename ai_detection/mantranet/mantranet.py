...
class IMTFE(nn.Module):
    ...
    def __init__(self, in_channel=3,device=device):
        ...
        # Note: SRMConv2D weights will be loaded via load_state_dict() from MantraNetv4.pt
        # Original code had: self.SRMConv2D.weight.data=torch.load('IMTFEv4.pt')['SRMConv2D.weight']
