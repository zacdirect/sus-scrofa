...
urlpatterns = [
    ...
    re_path(r"^show/(?P<analysis_id>[\d]+)/static/$", views.show_static, name="show_static"),
    re_path(r"^show/(?P<analysis_id>[\d]+)/exif/$", views.show_exif, name="show_exif"),
    re_path(r"^show/(?P<analysis_id>[\d]+)/iptc/$", views.show_iptc, name="show_iptc"),
    re_path(r"^show/(?P<analysis_id>[\d]+)/xmp/$", views.show_xmp, name="show_xmp"),
    re_path(r"^show/(?P<analysis_id>[\d]+)/preview/$", views.show_preview, name="show_preview"),
    re_path(r"^show/(?P<analysis_id>[\d]+)/location/$", views.show_location, name="show_location"),
    re_path(r"^show/(?P<analysis_id>[\d]+)/automated/$", views.show_automated, name="show_automated"),
